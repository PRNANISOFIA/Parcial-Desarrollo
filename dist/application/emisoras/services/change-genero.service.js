...
exports.ChangeGeneroService = void 0;
...
let ChangeGeneroService = class ChangeGeneroService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarGenero(new genero_vo_1.Genero(command.genero));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangeGeneroService = ChangeGeneroService;
exports.ChangeGeneroService = ChangeGeneroService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangeGeneroService);
//# sourceMappingURL=change-genero.service.js.map