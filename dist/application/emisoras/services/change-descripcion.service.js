...
exports.ChangeDescripcionService = void 0;
...
let ChangeDescripcionService = class ChangeDescripcionService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarDescripcion(new descripcion_vo_1.Descripcion(command.descripcion));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangeDescripcionService = ChangeDescripcionService;
exports.ChangeDescripcionService = ChangeDescripcionService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangeDescripcionService);
//# sourceMappingURL=change-descripcion.service.js.map