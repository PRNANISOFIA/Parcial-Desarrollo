...
exports.ChangePaisService = void 0;
...
let ChangePaisService = class ChangePaisService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarPais(new pais_vo_1.Pais(command.pais));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangePaisService = ChangePaisService;
exports.ChangePaisService = ChangePaisService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangePaisService);
//# sourceMappingURL=change-pais.service.js.map