...
exports.ChangeCanalService = void 0;
...
let ChangeCanalService = class ChangeCanalService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarCanal(new canal_vo_1.Canal(command.canal));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangeCanalService = ChangeCanalService;
exports.ChangeCanalService = ChangeCanalService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangeCanalService);
//# sourceMappingURL=change-canal.service.js.map