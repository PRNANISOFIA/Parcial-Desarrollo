...
exports.ChangeEstadoService = void 0;
...
let ChangeEstadoService = class ChangeEstadoService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarEstado(new estado_emisora_vo_1.EstadoEmisora(command.estado));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangeEstadoService = ChangeEstadoService;
exports.ChangeEstadoService = ChangeEstadoService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangeEstadoService);
//# sourceMappingURL=change-estado.service.js.map