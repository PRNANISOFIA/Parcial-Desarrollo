...
exports.ChangeLocutoresService = void 0;
...
let ChangeLocutoresService = class ChangeLocutoresService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarLocutores(new numero_locutores_vo_1.NumeroLocutores(command.numLocutores));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangeLocutoresService = ChangeLocutoresService;
exports.ChangeLocutoresService = ChangeLocutoresService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangeLocutoresService);
//# sourceMappingURL=change-locutores.service.js.map