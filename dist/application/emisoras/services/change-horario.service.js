...
exports.ChangeHorarioService = void 0;
...
let ChangeHorarioService = class ChangeHorarioService {
    emisoraRepository;
    ...
    async execute(command) {
        ...
        emisora.cambiarHorario(new horario_vo_1.Horario(command.horario));
        await this.emisoraRepository.save(emisora);
        return emisora_mapper_1.EmisoraMapper.toResponse(emisora);
    }
};
exports.ChangeHorarioService = ChangeHorarioService;
exports.ChangeHorarioService = ChangeHorarioService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [emisora_repository_1.EmisoraRepository])
], ChangeHorarioService);
//# sourceMappingURL=change-horario.service.js.map